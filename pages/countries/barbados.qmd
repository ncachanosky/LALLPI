...
```{python}
#| echo: false
#| label: fig-barbados-trend
#| fig-cap: "Barbados: POP, PEP, and PIP by year"

import matplotlib.pyplot as plt

fig = sh.build_country_trend_chart(df, "BRB")
plt.show()
```
...
```{python}
#| echo: false
#| label: fig-barbados-breakdown
#| fig-cap: "Barbados: sub-index components, latest year"

fig = sh.build_subindex_breakdown_chart(df, "BRB")
plt.show()
```

## Barbados vs. the regional average

```{python}
#| echo: false
#| label: fig-barbados-regional
#| fig-cap: "Barbados vs. regional average POP"

fig = sh.build_regional_comparison_chart(df, "BRB")
plt.show()
```
...
display(HTML(sh.build_party_history_table_html(df, "BRB")))
```
