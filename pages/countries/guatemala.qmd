...
```{python}
#| echo: false
#| label: fig-guatemala-trend
#| fig-cap: "Guatemala: POP, PEP, and PIP by year"

import matplotlib.pyplot as plt

fig = sh.build_country_trend_chart(df, "GTM")
plt.show()
```
...
```{python}
#| echo: false
#| label: fig-guatemala-breakdown
#| fig-cap: "Guatemala: sub-index components, latest year"

fig = sh.build_subindex_breakdown_chart(df, "GTM")
plt.show()
```

## Guatemala vs. the regional average

```{python}
#| echo: false
#| label: fig-guatemala-regional
#| fig-cap: "Guatemala vs. regional average POP"

fig = sh.build_regional_comparison_chart(df, "GTM")
plt.show()
```
...
display(HTML(sh.build_party_history_table_html(df, "GTM")))
```
