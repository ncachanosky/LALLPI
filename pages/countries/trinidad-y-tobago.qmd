...
```{python}
#| echo: false
#| label: fig-trinidad-y-tobago-trend
#| fig-cap: "Trinidad y Tobago: POP, PEP, and PIP by year"

import matplotlib.pyplot as plt

fig = sh.build_country_trend_chart(df, "TTO")
plt.show()
```
...
```{python}
#| echo: false
#| label: fig-trinidad-y-tobago-breakdown
#| fig-cap: "Trinidad y Tobago: sub-index components, latest year"

fig = sh.build_subindex_breakdown_chart(df, "TTO")
plt.show()
```

## Trinidad y Tobago vs. the regional average

```{python}
#| echo: false
#| label: fig-trinidad-y-tobago-regional
#| fig-cap: "Trinidad y Tobago vs. regional average POP"

fig = sh.build_regional_comparison_chart(df, "TTO")
plt.show()
```
...
display(HTML(sh.build_party_history_table_html(df, "TTO")))
```
