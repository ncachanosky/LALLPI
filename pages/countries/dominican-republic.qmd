...
```{python}
#| echo: false
#| label: fig-dominican-republic-trend
#| fig-cap: "Dominican Republic: POP, PEP, and PIP by year"

import matplotlib.pyplot as plt

fig = sh.build_country_trend_chart(df, "DOM")
plt.show()
```
...
```{python}
#| echo: false
#| label: fig-dominican-republic-breakdown
#| fig-cap: "Dominican Republic: sub-index components, latest year"

fig = sh.build_subindex_breakdown_chart(df, "DOM")
plt.show()
```

## Dominican Republic vs. the regional average

```{python}
#| echo: false
#| label: fig-dominican-republic-regional
#| fig-cap: "Dominican Republic vs. regional average POP"

fig = sh.build_regional_comparison_chart(df, "DOM")
plt.show()
```
...
display(HTML(sh.build_party_history_table_html(df, "DOM")))
```
