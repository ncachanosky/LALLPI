...
```{python}
#| echo: false
#| label: fig-colombia-trend
#| fig-cap: "Colombia: POP, PEP, and PIP by year"

import matplotlib.pyplot as plt

fig = sh.build_country_trend_chart(df, "COL")
plt.show()
```
...
```{python}
#| echo: false
#| label: fig-colombia-breakdown
#| fig-cap: "Colombia: sub-index components, latest year"

fig = sh.build_subindex_breakdown_chart(df, "COL")
plt.show()
```

## Colombia vs. the regional average

```{python}
#| echo: false
#| label: fig-colombia-regional
#| fig-cap: "Colombia vs. regional average POP"

fig = sh.build_regional_comparison_chart(df, "COL")
plt.show()
```
...
display(HTML(sh.build_party_history_table_html(df, "COL")))
```
