...
```{python}
#| echo: false
#| label: fig-costa-rica-trend
#| fig-cap: "Costa Rica: POP, PEP, and PIP by year"

import matplotlib.pyplot as plt

fig = sh.build_country_trend_chart(df, "CRI")
plt.show()
```
...
```{python}
#| echo: false
#| label: fig-costa-rica-breakdown
#| fig-cap: "Costa Rica: sub-index components, latest year"

fig = sh.build_subindex_breakdown_chart(df, "CRI")
plt.show()
```

## Costa Rica vs. the regional average

```{python}
#| echo: false
#| label: fig-costa-rica-regional
#| fig-cap: "Costa Rica vs. regional average POP"

fig = sh.build_regional_comparison_chart(df, "CRI")
plt.show()
```
...
display(HTML(sh.build_party_history_table_html(df, "CRI")))
```
